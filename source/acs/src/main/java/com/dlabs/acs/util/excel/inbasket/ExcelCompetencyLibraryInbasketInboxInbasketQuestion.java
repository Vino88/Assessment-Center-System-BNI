...
public class ExcelCompetencyLibraryInbasketInboxInbasketQuestion {
			...
			getPCLbl: while (rowIterator.hasNext())
			{
				...
				while (cellIterator.hasNext())
				{
					...
					if (cell.getCellType() == Cell.CELL_TYPE_STRING || cell.getCellType() == Cell.CELL_TYPE_NUMERIC)
					{
						...
						{
							inbasketInboxInbasketQuestion.setCompetencyName(cell.getStringCellValue());
						}
	...
	public static void main(String[] args) {
		InputStream is =ExcelInbasketInboxInbasketQuestion.class.getClassLoader().getResourceAsStream("init/CompetencyLibraryInbasketInboxInbasketQuestion.xlsx");
