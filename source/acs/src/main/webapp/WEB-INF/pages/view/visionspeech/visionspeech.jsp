	...
	<div class="right_col">
      	<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12">
				<form  method="POST" action="${pageContext.request.contextPath}/controller/pages/view/visionspeech/detail/visionspeechvs" class="form-horizontal row-fluid">
                    ...
                    <div class="x_panel">
		              	...
		              	<div class="x_content">
		                  	<p>Rekamlah video Anda selama maksimal <b>3 (tiga)</b> menit, dan hanya dalam <b>2 (dua) kali</b> kesempatan. Untuk itu Anda diminta untuk membuat draft penjelasan sebelum merekam.</p>			
		              	</div>
	              	</div>
		              	...
		              	<div class="x_content">
						    ...
						    <div class="module-head">
								...
								<c:choose>
									...
									<p id="paragraphPlay" >
									<a href="${pageContext.request.contextPath}/controller/pages/view/visionspeech/play?now=${now.time}" class="btn btn-success">Putar video dari server</a>
								</p>
									</c:when>
									<c:otherwise>
								...
								<p id="paragraphInfoVisionSpeech" style="display:none">
									...
									<br/><br/><i class="fa fa-caret-right"></i> Anda telah <span id="numOfRecord"> ${sessionScope.session_participant_log_during.visionCount }</span> kali merekam.
								</p>
	              		...
	              		<div class="x_content">
	              			<div class="form-group">
	                        	<div class="col-md-6 col-sm-6 col-xs-12">
		                        	<a class="btn btn-primary" href="${pageContext.request.contextPath}/controller/pages/view/home">Beranda</a>
		                        	<a class="btn btn-success"  href="javascript:nextPageVs()">Lanjut</a>
	                        	</div>
	                      	</div>
	              		</div>
	              	</div>
