...
function isAllCheckedFlagArray()
{
	...
	if(flagArray[9].value == "true" || flagMemoArray[9].value == true)
	{
		result = true;
	}else if(flagArray[10].value == "true" || flagMemoArray[10].value == true)
	{
		result = true;
	}
	else
	...
	<div class="right_col">
		<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12">
           		<div class="x_panel">
           			<div class="x_title">
           				<h2>Simulasi Rencana Bisniss <span id="timer" style="display:none"></span>
							</h2>
