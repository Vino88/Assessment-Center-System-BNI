...
<div style="text-align: center">
	<input type="button" id="prevSlideSection1" value="Pertanyaan Sebelumnya" class="btn btn-primary" />
	<input type="button" id="nextSlideSection1" value="Pertanyaan Selanjutnya" class="btn btn-success" />
