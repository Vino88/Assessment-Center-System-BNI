	...
	<div class="right_col">
      	<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12">
				<form  method="POST" action="${pageContext.request.contextPath}/controller/pages/view/analysys/detail/visionspeechvs" class="form-horizontal row-fluid">
		              	...
		              	<div class="x_content">
						    ...
						    <div class="module-head">
								...
								<c:set var="now" value="<%=new java.util.Date()%>" />
									<a href="${pageContext.request.contextPath}/controller/view/visionspeech/play?now=${now.time}" target="_action" class="btn btn-success">Putar video dari server</a>
								</p>
							</div>
		              	</div>
		          	</div>
