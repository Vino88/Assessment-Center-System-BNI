	...
	<div class="right_col">
      	<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12">
                  ...
                  <form  method="POST" action="${pageContext.request.contextPath}/controller/pages/view/analysys/detail" class="form-horizontal row-fluid">
                      ...
                      <div class="x_panel">
	               		...
	               		<div class="x_content">
	              			<iframe style="display:none" id="frameSrb" frameborder="0" src="${staticfiles}/static/articulate/gsi/20170330/story.html" width="100%" height="600px"></iframe>
	              			
	              			</div>
	                  	<div class="x_content">
	                    	<p class="font-gray-dark"> 
	                    		<c:choose>
<c:when test="${analysys.number >5}" >
${analysys.number-1}. ${analysys.question}
</c:when>
<c:otherwise>
${analysys.number}. ${analysys.question}
</c:otherwise>
</c:choose>
	                    	</p>
                  ...
                  <div class="x_panel">
	              		...
	              		<div class="x_content">
	              			<div class="form-group">
	                        	...
	                        	<a class="btn btn-primary" href="${pageContext.request.contextPath}/controller/pages/view/analysys"><fmt:message key="btn.prev"></fmt:message></a>
	                        	</c:when>
