      ...
      <div class="row">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Competency for SRB (History)</h2>
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
					 	...
					 	<c:forEach items="${listParticipantCompetencyResultDisplayDto}" var="dto">
					 		<div class="form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<a href="${pageContext.request.contextPath}/controller/pages/admin/assessor/participant/analysis/competency/${participant.id}/${dto.competencyLibrary.id}" class="btn btn-success form-control col-md-7 col-xs-12">${dto.competencyLibrary.competencyName}</a>
		                        </div>
							 	</div>
							 	<div class="ln_solid"></div>
					 	</c:forEach>
