		...
		$("#btnFinishNow").click(function(e){
			...
			alertify.confirm('Are you sure you want to finish now?', 
					function(e){
						if(e)
						{
							$("#formIg").attr("action", "${pageContext.request.contextPath}/controller/pages/admin/assessor/assess/integrationgrid/ratingandfinish/${participant.id}");
							$("#formIg").submit();
						}
					}
		    );
		...
		var options = {
		        ...
		        new Chart(document.getElementById("canvas1"), {
		          ...
		          data: {
		            ...
		            datasets: [{
		              data: [${spmFlag.notSure },${spmFlag.answer }, ${spmFlag.emptyFlag }],
		              backgroundColor: [
		        ...
		        new Chart(document.getElementById("canvas2"), {
			          ...
			          data: {
			            ...
			            datasets: [{
			            	data: [${srbFlag.notSure },${srbFlag.answer }, ${srbFlag.emptyFlag }],
			              backgroundColor: [
		        ...
		        new Chart(document.getElementById("canvas3"), {
			          ...
			          data: {
			            ...
			            datasets: [{
			            	data: [${capFlag.notSure },${capFlag.answer }, ${capFlag.emptyFlag }],
			              backgroundColor: [
