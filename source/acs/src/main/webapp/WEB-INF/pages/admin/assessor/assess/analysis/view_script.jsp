<form action="${pageContext.request.contextPath}/controller/pages/admin/assessor/assess/analysis/finish/${participant.id}" method="POST" id="formFinish" syle="display:none">
