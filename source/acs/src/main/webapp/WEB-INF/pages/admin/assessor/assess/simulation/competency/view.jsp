...
<div class="main_container" role="main" >
      ...
      <div class="row">
            ...
            <a class="btn btn-app" href="${pageContext.request.contextPath}/controller/pages/admin/assessor/assess/simulation/view/${participant.id}" style="margin: 0px 0px 10px 0px;"><i class="fa fa-arrow-circle-left"></i>Back</a>
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Competency "${competencyLibrary.competencyName}" for SPM</h2>
                ...
                <div class="x_panel">
	              	...
	              	<div class="x_panel">
	              		...
	              		<div class="x_content">
	              		 <form id="assessForm" method="POST" id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left" action="${pageContext.request.contextPath}/controller/pages/admin/assessor/assess/simulation/competency/assess" >
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12" id="containerRadio">
                           <div class="radio">
                            <label>
                              <input type="radio" class="flat" name="asessmentFlag" <c:if test="${participantCompetencyLibraryFinalResult.inbasketFlag == 'NOT_SURE' }">checked="checked"</c:if>  value="NOT_SURE"> I'm not sure
                            </label>
                          </div>
                          
                           <div class="radio">
                            <label>
                              <input type="radio" class="flat" name="asessmentFlag" <c:if test="${participantCompetencyLibraryFinalResult.inbasketFlag == 'ANSWER_CANT_ASSESSED' }">checked="checked"</c:if> value="ANSWER_CANT_ASSESSED"> Participant Answer can't be assessed
                            </label>
                          </div>
                          <div class="radio">
                            <label>
	              		...
	              		<div class="x_content">
	              			<div class="form-group">
	                        	<div class="col-md-6 col-sm-6 col-xs-12">
		                        	...
		                        	<a href="${pageContext.request.contextPath}/controller/pages/admin/assessor/assess/simulation/view/${participant.id}" class="btn btn-primary">Back</a>
