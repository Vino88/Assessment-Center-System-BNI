...
<script>
	$(document).ready(function() {
		...
		<c:choose>
			<c:when test="${participantCompetencyLibraryFinalResult.analysisRating > 0 }">
				
				$("tr[id^='clBehaviour']:nth-child(${participantCompetencyLibraryFinalResult.analysisRating })").css( "display", "" );
				$( "#starRating a:lt(${participantCompetencyLibraryFinalResult.analysisRating })" ).removeClass("fa-star-o");
				$( "#starRating a:lt(${participantCompetencyLibraryFinalResult.analysisRating })" ).addClass("fa-star");
				
				$( "tr[id^='clBehaviour']:nth-child(${participantCompetencyLibraryFinalResult.analysisRating})").css("background-color", "#337ab7" );
				$( "tr[id^='clBehaviour']:nth-child(${participantCompetencyLibraryFinalResult.analysisRating})").css("color", "#fff" );
				
				$("tr[id^='clBehaviour']:gt(${participantCompetencyLibraryFinalResult.analysisRating - 1})").css( "display", "" );
