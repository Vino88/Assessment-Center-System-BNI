	...
	<div class="right_col">
		...
		<div class="col-md-4 col-sm-6 col-xs-12">
			...
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					<div class="x_title">
                    	<h2>Integration Grid (History)</h2>
                    	<div class="clearfix"></div>
                  	</div>
                  	<div class="x_content">
                    	<br>
		                    ...
		                    <div class="clearfix"></div>
	              			...
	              			<div class="form-group">
	                        	<div class="col-md-12 col-sm-6 col-xs-12">
		                        	...
		                        	<textarea id="participantStrong" rows="8" readonly="readonly"
										class="form-control col-md-12 col-xs-12 resizable_textarea"
										name="strong">${profile.strongIg }</textarea>
								</div>
                        	</div>
                      	</div>
                      	<div class="x_content">
	              			...
	              			<div class="form-group">
	                        	<div class="col-md-12 col-sm-6 col-xs-12">
		                        	...
		                        	<textarea rows="8" id="participantWeakness" readonly="readonly"
										class="form-control col-md-12 col-xs-12 resizable_textarea"
										name="weakness">${profile.weaknessIg }</textarea>
								</div>
                        	</div>
                      	</div>
                      	<div class="x_content">
	              			...
	              			<div class="form-group">
	                        	<div class="col-md-12 col-sm-6 col-xs-12">
		                        	...
		                        	<textarea rows="8" id="personalCompetency" readonly="readonly"
										class="form-control col-md-12 col-xs-12 resizable_textarea"
										name="personalCompetency">${profile.personalCompetencyIg }</textarea>
								</div>
                        	</div>
                      	</div>
                      	<div class="x_content">
	              			...
	              			<div class="form-group">
	                        	<div class="col-md-12 col-sm-6 col-xs-12">
		                        	...
		                        	<textarea rows="8" id="leadershipCompetency" readonly="readonly"
										class="form-control col-md-12 col-xs-12 resizable_textarea"
										name="leadershipCompetency">${profile.leadershipCompetencyIg }</textarea>
								</div>
                        	</div>
                      	</div>
                      	<div class="x_content">
	              			...
	              			<div class="form-group">
	                        	<div class="col-md-12 col-sm-6 col-xs-12">
		                        	...
		                        	<textarea rows="8" id="functionalCompetency" readonly="readonly"
										class="form-control col-md-12 col-xs-12 resizable_textarea"
										name="functionalCompetency">${profile.functionalCompetencyIg }</textarea>
								</div>
                        	</div>
                      	</div>
              		</div>
