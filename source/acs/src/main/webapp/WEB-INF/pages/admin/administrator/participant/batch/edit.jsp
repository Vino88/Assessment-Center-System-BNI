              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form method="POST" id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left" action="${ pageContext.request.contextPath}/controller/pages/admin/administrator/participant/batch/edit">
					  <input type="hidden" name="id" value="${ dataForm.id}" />
						...
						<select name="inprogress" required="required" class="form-control">
						 ...
						 <div class="form-group">
						<label class="control-label col-md-3 col-sm-3 col-xs-12" for="category">Location <span class="required red">*</span></label>
						<div class="col-md-6 col-sm-6 col-xs-12">
							<input type="text" name="location" required="required" class="form-control col-md-7 col-xs-12" value="${ dataForm.location}">
                        </div>
					 </div>
					 ...
					 <div class="form-group">
						...
						<select name="locationSecond" required="required" class="form-control">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" name="assessementFinishTimeStr" id="assessementFinishTimeStr" readonly="readonly" required="required" class="form-control col-md-7 col-xs-12 datetimepicker" value='<fmt:formatDate  value="${dataForm.assessementFinishTime }" pattern="dd-MM-yyyy HH:mm" />'/>
	                        </div>
						 </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <a href="${ pageContext.request.contextPath}/controller/pages/admin/administrator/participant/batch/view" class="btn btn-primary">Cancel</a>
