...
<div class="main_container" role="main" >
      ...
      <div class="row">
            ...
            <a class="btn btn-app" href="${pageContext.request.contextPath}/controller/pages/admin/assessor/participant/cap/list/${participant.id}" style="margin: 0px 0px 10px 0px;"><i class="fa fa-arrow-circle-left"></i>Back</a>
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>PK - ${cap.number} (History)</h2>
                ...
                <div class="x_panel">
	              	...
	              	<div class="x_panel">
                        ...
                        <div class="col-md-10 col-sm-10 col-xs-12" id="containerRadio${count.index}">
                           <div class="radio">
                            <label>
                              <input type="radio" readonly="readonly" class="flat" name="listResult[${count.index}].asessmentFlag" <c:if test="${dto.participantCompetencyLibraryFinalResult.capFlag == 'NOT_SURE' }">checked="checked"</c:if>  value="NOT_SURE"> I'm not sure
                            </label>
                          </div>
                          
                           <div class="radio">
                            <label>
                              <input type="radio" readonly="readonly" class="flat" name="listResult[${count.index}].asessmentFlag" <c:if test="${dto.participantCompetencyLibraryFinalResult.capFlag == 'ANSWER_CANT_ASSESSED' }">checked="checked"</c:if> value="ANSWER_CANT_ASSESSED"> Participant Answer can't be assessed
                            </label>
                          </div>
	              		...
	              		<div class="x_content">
	              			<div class="form-group">
	                        	<div class="col-md-6 col-sm-6 col-xs-12">
		                        	...
		                        	<a href="${pageContext.request.contextPath}/controller/pages/admin/assessor/participant/cap/list/${participant.id}" class="btn btn-primary">Back</a>
