      ...
      <div class="row">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Add CompetencyLibraryAnalysys</h2>
                  ...
                  <div class="x_content">
                    ...
                    <form method="POST" id="entityForm" data-parsley-validate="" class="form-horizontal form-label-left" action="${ pageContext.request.contextPath}/controller/pages/admin/administrator/analysys/competencylibraryanalysys/add">
