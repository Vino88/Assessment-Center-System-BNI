...
<div class="main_container" role="main" >
      ...
      <div class="row">
            ...
            <a href="${ pageContext.request.contextPath}/controller/pages/admin/administrator/participant/batch/inprogress/view" class="btn btn-app" style="margin: 0px 0px 10px 0px;"><i class="fa fa-arrow-circle-left"></i>Back</a>
            <div class="row">
                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                      <li><a href="${ pageContext.request.contextPath}/controller/pages/admin/administrator/participant/batch/participant/add/${dataForm.id}" class="btn btn-app"><i class="fa fa-plus"></i>Add</a></li>
                      
                      <li><a href="${ pageContext.request.contextPath}/controller/pages/admin/administrator/participant/batch/participant/sendinvitation/${dataForm.id}" class="btn btn-app"><i class="fa fa-envelope"></i>Send Invitation</a></li>
					 ...
					 <div class="form-group">
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
						 ...
						 <div class="form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" name="operatorUserName" required="required" readonly="readonly" class="form-control col-md-7 col-xs-12" value='${dataForm.userAdmin.username }'/>
	                        </div>
						 </div>
