              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form method="POST" id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left" action="${ pageContext.request.contextPath}/controller/pages/admin/administrator/analysys/analysys/edit">
					  <input type="hidden" name="id" value="${ dataForm.id}" />
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" name="analysysType" required="required" class="form-control col-md-7 col-xs-12" value="${ dataForm.analysysType}"/>
	                        </div>
						 </div>
												 <div class="form-group">
							<label class="control-label col-md-3 col-sm-3 col-xs-12" for="category">Question <span class="required red">*</span></label>
							<div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" name="question" required="required" class="form-control col-md-7 col-xs-12" value="${ dataForm.question}"/>
	                        </div>
						 </div>
