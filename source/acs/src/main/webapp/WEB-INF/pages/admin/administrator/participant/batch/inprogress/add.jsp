              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form method="POST" id="entityForm" data-parsley-validate="" class="form-horizontal form-label-left" action="${ pageContext.request.contextPath}/controller/pages/admin/administrator/participant/batch/add">
					 ...
					 <div class="form-group">
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<input type="number" name="maxQuota" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
					 </div>
					 ...
					 <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea class="form-control" rows="5" name="additionalInformation" placeholder="Additional Information"></textarea>
                        </div>
                      </div>
					 ...
					 <div class="form-group">
						...
						<select name="location" required="required" class="form-control">
							...
							<option value="Lokasi Masing-masing">Lokasi Masing-masing</option>
						</select>
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<input type="text" name="assessementFirstHalfStartTimeStr" id="assessementFirstHalfStartTimeStr"  required="required" class="form-control col-md-7 col-xs-12 datetimepicker">
                        </div>
					 </div>
										 <div class="form-group">
						<label class="control-label col-md-3 col-sm-3 col-xs-12" for="category">Session I, End Time <span class="required red">*</span></label>
						<div class="col-md-6 col-sm-6 col-xs-12">
							<input type="text" name="assessementFirstHalfEndTimeStr" id="assessementFirstHalfEndTimeStr" required="required" class="form-control col-md-7 col-xs-12 datetimepicker">
                        </div>
					 </div>
					 ...
					 <div class="form-group">
						<label class="control-label col-md-3 col-sm-3 col-xs-12" for="category">Location Session II <span class="required red">*</span></label>
						<div class="col-md-6 col-sm-6 col-xs-12">
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<input type="text" name="assessementSecondHalfStartTimeStr" id="assessementSecondHalfStartTimeStr" required="required" class="form-control col-md-7 col-xs-12 datetimepicker">
                        </div>
					 </div>
										 <div class="form-group">
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<input type="text" readonly="readonly" name="assessementFinishTimeStr" id="assessementFinishTimeStr" required="required" class="form-control col-md-7 col-xs-12 datetimepicker">
                        </div>
					 </div>
					<div class="ln_solid"></div>
					 ...
					 <div class="form-group">
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<input type="text" name="operatorUserName" id="operatorUserName" readonly="readonly" required="required" class="form-control col-md-7 col-xs-12">
							<input type="hidden" name="userId" id="userId" required="required" class="form-control col-md-7 col-xs-12">
