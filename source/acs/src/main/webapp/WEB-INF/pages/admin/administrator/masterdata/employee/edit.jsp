              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form method="POST" id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left" action="${ pageContext.request.contextPath}/controller/pages/admin/administrator/masterdata/employee/edit">
					  <input type="hidden" name="id" value="${ dataForm.id}" />
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" name="dateOfBirthStr" required="required" class="form-control col-md-7 col-xs-12 date-picker" value='<fmt:formatDate value="${ dataForm.dateOfBirth}" pattern="dd-MM-yyyy" />'/>
	                        </div>
						 </div>
												 <div class="form-group">
