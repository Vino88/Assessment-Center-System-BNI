<form action="${pageContext.request.contextPath}/controller/pages/admin/assessor/assess/simulation/finish/${participant.id}" method="POST" id="formFinish" syle="display:none">
