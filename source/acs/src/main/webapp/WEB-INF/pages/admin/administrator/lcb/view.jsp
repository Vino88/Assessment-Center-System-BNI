                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                      <li><a class="btn btn-app" href="${pageContext.request.contextPath}/controller/pages/admin/administrator/dayalima/news/add" style="margin: 0px 0px 10px 0px;"><i class="fa fa-plus"></i> Add</a></li>
                    </ul>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    
                    <table id="newsDatatable" class="table table-striped table-bordered">
                      <thead>
                        <tr>
                          <th>No</th>
                          <th>Question</th>
