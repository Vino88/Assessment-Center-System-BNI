	...
	<div class="right_col">
		...
		<div class="col-md-4 col-sm-6 col-xs-12">
			...
			<div class="col-md-12 col-sm-12 col-xs-12">
				...
				<form method="POST" id="formIg" action="${pageContext.request.contextPath}/controller/pages/admin/assessor/assess/reviewer/rating/${participant.id}">
                	<div class="x_panel">
		                    ...
		                    <div class="clearfix"></div>
	              			...
	              			<div class="form-group">
	                        	<div class="col-md-12 col-sm-6 col-xs-12">
		                        	...
		                        	<textarea rows="8" id="participantStrong"
										class="form-control col-md-12 col-xs-12 resizable_textarea"
