          ...
          <div class="row">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>InbasketQuestion</h2>
                    <ul class="nav navbar-right panel_toolbox">
                      <li><a class="btn btn-app" href="${ pageContext.request.contextPath}/controller/pages/admin/administrator/inbasket/inbasketquestion/add" style="margin: 0px 0px 10px 0px;"><i class="fa fa-plus"></i> Add</a></li>
                    </ul>
